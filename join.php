...
<head>
    ...
    <meta name="description"
        content="Join the Bali Tech Hub community for free. Connect with developers, designers, and tech enthusiasts in Bali.">
    ...
    <section class="pt-32 pb-20 bg-custom-black text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-300 max-w-2xl mx-auto">
                Join the fastest growing tech community in Bali. Connect, learn, and grow with us.
            </p>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold mb-4">Discord Community</h3>
                    <p class="text-gray-600 mb-8">Join our main community server for discussions, events, and
                        networking.</p>
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold mb-4">WhatsApp Group</h3>
                    <p class="text-gray-600 mb-8">Quick updates and community chat on WhatsApp.</p>
