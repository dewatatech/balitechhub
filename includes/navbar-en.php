<nav class="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-sm border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-8">
                    ...
                    <div class="flex items-center ml-4 pl-4 border-l border-gray-300">
                        <a href="/" class="text-custom-black hover:text-gray-600 px-2 py-1 text-sm font-medium transition-colors duration-300">EN</a>
            ...
            <div class="md:hidden">
                <button id="mobile-menu-button" class="text-custom-black hover:text-gray-600 focus:outline-none">
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-white border-t border-gray-200">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <div class="flex items-center justify-center px-3 py-2 border-t border-gray-200 mt-2 pt-2">
                <a href="/" class="text-custom-black hover:text-gray-600 px-3 py-1 text-sm font-medium">EN</a>
