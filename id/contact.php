...
<head>
    ...
    <meta name="description" content="Hubungi Bali Tech Hub. Temukan informasi kontak, tautan media sosial, dan terhubung dengan komunitas teknologi yang berkembang pesat di Bali.">
    <meta name="keywords" content="kontak Bali Tech Hub, komunitas teknologi Bali, acara teknologi Bali, komunitas startup Bali">
    <meta name="author" content="Bali Tech Hub">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Hubungi Kami - Bali Tech Hub">
    <meta property="og:description" content="Terhubung dengan komunitas teknologi yang berkembang pesat di Bali. Temukan informasi kontak dan tautan media sosial kami.">
    ...
    <meta name="twitter:description" content="Terhubung dengan komunitas teknologi yang berkembang pesat di Bali. Temukan informasi kontak dan tautan media sosial kami.">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16 fade-in">
                ...
                <p class="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed fade-in">
                    Hubungi kami melalui saluran mana saja. Kami selalu antusias untuk terhubung dengan para pecinta teknologi, mitra potensial, dan anggota komunitas.
                </p>
            </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div class="fade-in">
                ...
                <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                    Menjadi bagian dari ekosistem teknologi Bali yang berkembang. Terhubung, belajar, dan berinovasi dengan sesama pecinta teknologi.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="https://chat.whatsapp.com/EOXtpHbgSSR32oh9xnvoK4" target="_blank" rel="noopener noreferrer" class="px-8 py-4 bg-white text-custom-black rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 shadow-lg inline-flex items-center">
